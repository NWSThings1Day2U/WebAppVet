...
public class controladorperfil extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      switch (accion) {
         case "listar" -> this.listarmascotas(request, response);
         case "filtrarMascotas" -> this.filtrarMascotas(request, response);
         default -> this.listarmascotas(request, response);
      }
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      if (id == null) {
         ...
         usuarios usu = this.dao.obtenerPerfil(id);
   ...
   protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      if (id != null) {
         ...
         boolean ok = this.dao.actualizarPerfil(id, nomUsu, nombre, correo, tel, pass, nuevaImagen);
         if (ok) {
